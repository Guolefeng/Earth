...
class PersistenceEffect extends Component {
    ...
    constructor(base, config = {}) {
      ...
      `,
        ...
        const framebuffer1 = new THREE.WebGLRenderTarget(
            innerWidth,
            innerHeight
        );
        const framebuffer2 = new THREE.WebGLRenderTarget(
            innerWidth,
            innerHeight
        );
    ...
    update(time) {
        ...
        const uvScaleX = THREE.MathUtils.mapLinear(
            this.scaleX,
            -1,
            1,
            1.05,
        ...
        const uvScaleY = THREE.MathUtils.mapLinear(
            this.scaleY,
            -1,
            1,
            1.05,
