...
// 开启sRGB颜色空间
const enableSRGBColorSpace = (renderer) => {
...
// 获取边界顶点
const getBoundsVertices = (bounds) => {
    let boundsVertices = [];
...
const exportGLTF = (input, { filename = "scene", trs = false, onlyVisible = true, binary = false, maxTextureSize = 4096, } = {}) => {
