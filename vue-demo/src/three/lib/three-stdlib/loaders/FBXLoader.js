...
class FBXTreeParser {
        ...
        if ("Video" in fbxTree.Objects) {
            ...
            for (const nodeID in videoNodes) {
                ...
                if ("Content" in videoNode) {
                    const arrayBufferContent = videoNode.Content instanceof ArrayBuffer &&
    ...
    parseParameters(materialNode, textureMap, ID) {
        ...
        else if (materialNode.SpecularColor &&
                ...
                case "Maya|TEX_color_map":
                    ...
                    if (parameters.map !== undefined) {
                        if ("colorSpace" in parameters.map)
                            ...
                            parameters.map.encoding = 3001; // sRGBEncoding
                    }
                    break;
                ...
                case "EmissiveColor":
                    ...
                    if (parameters.emissiveMap !== undefined) {
                        if ("colorSpace" in parameters.emissiveMap)
                            ...
                            parameters.emissiveMap.encoding = 3001; // sRGBEncoding
                    }
                    break;
                case "NormalMap":
                ...
                case "ReflectionColor":
                    ...
                    if (parameters.envMap !== undefined) {
                        ...
                        if ("colorSpace" in parameters.envMap)
                            ...
                            parameters.envMap.encoding = 3001; // sRGBEncoding
                    }
                    break;
                case "SpecularColor":
                    ...
                    if (parameters.specularMap !== undefined) {
                        if ("colorSpace" in parameters.specularMap)
                            ...
                            parameters.specularMap.encoding = 3001; // sRGBEncoding
                    }
                    break;
    ...
    getTexture(textureMap, id) {
        ...
        if ("LayeredTexture" in fbxTree.Objects &&
    ...
    createLight(relationships) {
        ...
        if (lightAttribute === undefined) {
            ...
            let intensity = lightAttribute.Intensity === undefined
                ? 1
            ...
            switch (type) {
                ...
                case 2: // Spot
                    ...
                    break;
                default:
                    console.warn("THREE.FBXLoader: Unknown light type " +
...
class GeometryParser {
    ...
    genMorphGeometry(parentGeo, parentGeoNode, morphGeoNode, preTransform, name) {
        const vertexIndices = parentGeoNode.PolygonVertexIndex !== undefined
