import { Color, Matrix4, Mesh, PerspectiveCamera, Plane, ShaderMaterial, UniformsUtils, Vector3, Vector4, WebGLRenderTarget, HalfFloatType, NoToneMapping, } from "three";
/**
    ...
    constructor(geometry, options = {}) {
        ...
        this.onBeforeRender = function (renderer, scene, camera) {
            ...
            // @ts-ignore
                ...
                isSRGB = renderer.outputEncoding === 3001; // sRGBEncoding
            ...
            // @ts-ignore
                ...
                renderer.outputEncoding = isSRGB ? 3001 : 3000;
