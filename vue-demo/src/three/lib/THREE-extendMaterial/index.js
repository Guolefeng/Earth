...
const { ShaderChunk, UniformsLib, Vector2, Color, EventDispatcher, TangentSpaceNormalMap, MultiplyOperation, Material, ShaderMaterial, RawShaderMaterial, } = THREE;
// Utility functions
...
// Fix missing pairs
const UniformsLibExtendable = UniformsLib;
...
function extend(source, object) {
    ...
    const MaterialClass = object.class ||
