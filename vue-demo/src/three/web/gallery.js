...
class Gallery extends Component {
    ...
    constructor(base, config = {}) {
        super(base);
        const { elList = [...document.querySelectorAll("img")], vertexShader = defaultVertexShader, fragmentShader = defaultFragmentShader, uniforms = {}, makuConfig = {}, isScrollPositionSync = true, scroller = null, materialParams = {}, isRectAutoRefreshed = false, } = config;
        this.elList = elList;
